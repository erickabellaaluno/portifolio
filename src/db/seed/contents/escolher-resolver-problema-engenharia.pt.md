Cada aluno deverá escolher e resolver um problema de engenharia utilizando LLMs. Cada aluno tem liberdade total para escolher o problema que quiser resolver.
Entregar:
