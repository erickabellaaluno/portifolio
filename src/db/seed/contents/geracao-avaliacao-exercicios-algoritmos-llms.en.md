In this activity, each student must use three different Large Language Models (LLMs) to generate and compare algorithm exercises applied to the fields of Electrical Engineering, Mechanical Engineering, and Telecommunications Engineering.
