Write the Python code for the lists/vectors/arrays exercises. For each exercise, implement and run the Python code. Show that you executed the code on your machine (for example: take a screenshot of the execution).
